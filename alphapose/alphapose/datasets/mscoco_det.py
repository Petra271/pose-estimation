...
sys.path.insert(1, '/content/drive/MyDrive/pose-estimation-research/alphapose/detector')
sys.path.insert(1, '/content/drive/MyDrive/pose-estimation-research/alphapose/alphapose/')
