...
sys.path.insert(1, '/content/drive/MyDrive/pose-estimation-research/alphapose/trackers/tracking')
sys.path.insert(1, '/content/drive/MyDrive/pose-estimation-research/alphapose/trackers/utils')
sys.path.insert(1, '/content/drive/MyDrive/pose-estimation-research/alphapose/trackers/ReidModels')
...
from ResBnLin import ResModel
from osnet import *
from osnet_ain import osnet_ain_x1_0
from resnet_fc import resnet50_fc512
