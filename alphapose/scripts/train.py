...
sys.path.insert(1, '/content/drive/MyDrive/alphapose/alphapose/models')
sys.path.insert(1, '/content/drive/MyDrive/alphapose/alphapose')
sys.path.insert(1, '/content/drive/MyDrive/alphapose/alphapose/utils')


import builder
from opt import cfg, logger, opt
from logger import board_writing, debug_writing
from metrics import DataLogger, calc_accuracy, calc_integral_accuracy, evaluate_mAP
from transforms import get_func_heatmap_to_coord
